...
// League caps, car part targets, facility targets, and community-recommended strategies
// Sources: GPRO Wiki, gprocalc.com, gpro-strategy.net, GPRO Pitwall, community forums
...
var GPRO_DATA = {
  ...
  // ============================================================
  // Based on community consensus: upgrade parts only when worn,
  ...
  // ============================================================
  // Verified against github.com/Jadax/gapp data.py profileFactors (2026-07-17) - matches
  ...
  // ============================================================
  tracks: {
    'Barcelona GP':     { overtaking: 'Hard', grip: 'Low', fuel: 'Medium', tyre: 'High', laps: 65, ctrGain: 2.832, ctrRace: 184.092, avgTemp: 30.46, pha: { power: 11, handling: 13, accel: 8, adv: 7 } },
    'Ahvenisto GP':     { overtaking: 'Normal', grip: 'Normal', fuel: 'Medium', tyre: 'Medium', laps: 80, ctrGain: 3.277, ctrRace: 262.175, avgTemp: 25.07, pha: { power: 5, handling: 10, accel: 7, adv: 8 } },
    'Magny Cours GP':   { overtaking: 'Hard', grip: 'High', fuel: 'Medium', tyre: 'Medium', laps: 72, ctrGain: 2.928, ctrRace: 210.845, avgTemp: 27.25, pha: { power: 12, handling: 8, accel: 11, adv: 5 } },
    'Poznan GP':        { overtaking: 'Hard', grip: 'Normal', fuel: 'Low', tyre: 'High', laps: 75, ctrGain: 2.856, ctrRace: 214.223, avgTemp: 27.66, pha: { power: 7, handling: 14, accel: 8, adv: 13 } },
    'Al-Ring GP':       { overtaking: 'Easy', grip: 'Low', fuel: 'Medium', tyre: 'High', laps: 71, ctrGain: 2.714, ctrRace: 192.694, avgTemp: 26.82, pha: { power: 13, handling: 8, accel: 9, adv: 9 } },
    'Jyllands-Ringen GP': { overtaking: 'Normal', grip: 'Normal', fuel: 'Very Low', tyre: 'Very High', laps: 136, ctrGain: 4.111, ctrRace: 559.049, avgTemp: 27.03, pha: { power: 5, handling: 9, accel: 4, adv: 9 } },
    'Silverstone GP':   { overtaking: 'Normal', grip: 'Normal', fuel: 'Medium', tyre: 'Medium', laps: 52, ctrGain: 2.302, ctrRace: 119.708, avgTemp: 27.14, pha: { power: 11, handling: 12, accel: 16, adv: 9 } },
    'Buenos Aires GP':  { overtaking: 'Very Hard', grip: 'Normal', fuel: 'Medium', tyre: 'High', laps: 72, ctrGain: 3.309, ctrRace: 238.233, avgTemp: 26.31, pha: { power: 12, handling: 11, accel: 9, adv: 4 } },
    'Austin GP':        { overtaking: 'Easy', grip: 'High', fuel: 'Medium', tyre: 'High', laps: 56, ctrGain: 3.242, ctrRace: 181.580, avgTemp: 28.42, pha: { power: 11, handling: 18, accel: 10, adv: 15 } },
    'Montreal GP':      { overtaking: 'Normal', grip: 'Very Low', fuel: 'Medium', tyre: 'Medium', laps: 69, ctrGain: 2.905, ctrRace: 200.463, avgTemp: 27.52, pha: { power: 12, handling: 7, accel: 13, adv: 7 } },
    'Spa GP':           { overtaking: 'Normal', grip: 'Normal', fuel: 'Medium', tyre: 'Medium', laps: 44, ctrGain: 2.543, ctrRace: 111.904, avgTemp: 14.79, pha: { power: 18, handling: 16, accel: 13, adv: 7 } },
    'Kaunas GP':        { overtaking: 'Normal', grip: 'Low', fuel: 'Medium', tyre: 'High', laps: 80, ctrGain: 2.908, ctrRace: 232.670, avgTemp: 20.21, pha: { power: 9, handling: 10, accel: 5, adv: 6 } },
    'Hungaroring GP':   { overtaking: 'Very Hard', grip: 'Very High', fuel: 'Medium', tyre: 'High', laps: 77, ctrGain: 3.206, ctrRace: 246.852, avgTemp: 25.56, pha: { power: 7, handling: 10, accel: 13, adv: 9 } },
    'Losail GP':        { overtaking: 'Hard', grip: 'High', fuel: 'Medium', tyre: 'Medium', laps: 57, ctrGain: 2.600, ctrRace: 148.198, avgTemp: 5.98, pha: { power: 13, handling: 16, accel: 9, adv: 10 } },
    'New Delhi GP':     { overtaking: 'Normal', grip: 'Very Low', fuel: 'Medium', tyre: 'High', laps: 60, ctrGain: 2.712, ctrRace: 162.742, avgTemp: 31.24, pha: { power: 11, handling: 15, accel: 10, adv: 9 } },
    'Yas Marina GP':    { overtaking: 'Hard', grip: 'High', fuel: 'Medium', tyre: 'Medium', laps: 55, ctrGain: 2.846, ctrRace: 156.526, avgTemp: 23.79, pha: { power: 12, handling: 10, accel: 17, adv: 12 } },
    'Baku City GP':     { overtaking: 'Easy', grip: 'High', fuel: 'Medium', tyre: 'Medium', laps: 51, ctrGain: 2.897, ctrRace: 147.757, avgTemp: 29.63, pha: { power: 18, handling: 8, accel: 16, adv: 12 } },
  },
  ...
  // ============================================================
  // GPROANALYZER CALIBRATION DATA (Spa GP, 44 laps, 13.5s pit loss)
  ...
  gproAnalyzerCalibration: {
    'Spa GP': {
      ...
      // Key insights from gproanalyzer data:
  ...
  // ============================================================
  // From Reddit community consensus: r/gpro, GPRO forums, wiki
  ...
  // ============================================================
  // GAPP-SOURCED TRACK DATA (github.com/Jadax/gapp, calcs.py/data.py)
  // Ported verbatim from the (unmaintained but formula-verified) GAPP project.
  ...
  gapp: {
    ...
    stopCalc: {
      ...
      // Keys match GPRO's actual (deliberately altered) in-game supplier names exactly, per GAPP source
    ...
    // Source: github.com/Jadax/gapp (unmaintained; formulas verified by reading calcs.py/data.py
    // source directly on 2026-07-17). NOT independently validated against this account's real
